          ...
          <button
            onClick={async () => {
              await microsoftTeams.chat.openChat({
                ...
                message: "Hi Adele! I am Ava Vellozzi, the new Explore intern on the Taos VSR Platform Team.",
              });
            }}
          >
            Start Chat
          ...
          <button
            onClick={async () =>
              await microsoftTeams.chat.openGroupChat({
                ...
                message:
                  "Hi Adele and Alex! I am Ava Vellozzi, the new Explore intern on the Taos VSR Platform Team. Nice to meet you both!",
                topic: "Group Chat",
              })
            }
          >
